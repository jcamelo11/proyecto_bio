...
trait FormatsMessages
{
    ...
    {
        $successAttribute = $this->getsuccessAttribute($attribute);

        $expectedAttributes = $attribute != $successAttribute
                    ? [$attribute, $successAttribute] : [$attribute];
        ...
        if (isset($this->implicitAttributes[$successAttribute])) {
