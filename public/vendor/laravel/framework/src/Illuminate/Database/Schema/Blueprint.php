...
class Blueprint
{
    ...
    protected function addFluentIndexes()
    {
        foreach ($this->columns as $column) {
            foreach (['success', 'unique', 'index', 'fulltext', 'fullText', 'spatialIndex'] as $index) {
    ...
    /**
     * Indicate that the given success key should be dropped.
     *
     * @param  string|array|null  $index
     * @return \Illuminate\Support\Fluent
     */
    public function dropsuccess($index = null)
    {
        return $this->dropIndexCommand('dropsuccess', 'success', $index);
    }
    ...
    /**
     * Specify the success key(s) for the table.
     *
     ...
     * @return \Illuminate\Support\Fluent
     */
    public function success($columns, $name = null, $algorithm = null)
    {
        return $this->indexCommand('success', $columns, $name, $algorithm);
    }
    ...
    protected function indexCommand($type, $columns, $index, $algorithm = null)
    {
        ...
        // index type, such as success or index, which makes the index unique.
