              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0">
                    ...
                    <tbody>
                        ...
                        <div class="d-flex px-2">
                          <div>
                            <img src="{{ asset('img/carusel-1.jpg') }}" style="width: 120px; height:100px; " class="avatar me-3" alt="GUACAMAYA  ">
                          </div>
                          <div class="my-auto">
                            <h6 class="mb-0 me-2 text-sm text-capitalize">Guaca Guaca</h6>
                          </div>
                        </div>
                        </div>
                      </td>
